...
CREATE TABLE IF NOT EXISTS user_game_details (
	id                serial,                       -- used as alternative to auto increment whichcannot be used in postgres  
	username          varchar(80) NOT NULL,
	game              varchar(80) NOT NULL,
	difficulty		  varchar(80) NOT NULL,
	games_won         int DEFAULT 0,
	games_lost        int DEFAULT 0,
	CONSTRAINT username_fk FOREIGN KEY (username) REFERENCES user_details(username)
);
